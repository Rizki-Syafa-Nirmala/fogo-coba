...
<div id="{{ $makanan->id }}" tabindex="-1" class="fixed inset-0 z-50 hidden w-full p-10 flex items-center justify-center">
    ...
    <div class="relative w-full max-w-4xl max-h-[80vh] overflow-y-auto">
        <!-- Modal content -->
        <div class="relative  bg-white rounded-lg shadow-sm border-2 ">
            <!-- Modal header -->
            <div class="flex items-center justify-between  p-4 md:p-5  rounded-t ">
                <button type="button" data-modal-hide="{{ $makanan->id }}" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center  ">
            ...
            <div class="pb-2 md:px-10">
                    ...
                    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
                      <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                        <div class="shrink-0 border border-orange-100 shadow-sm shadow-orange-100 max-w-md lg:max-w-lg mx-auto">
                          ...
                          <img class="w-full   " src="{{ $makanan->gambar_makanan ? asset('storage/'.$makanan->gambar_makanan) : asset('images/food.png') }}" alt="" />
                          <img class="w-full hidden " src="{{ $makanan->gambar_makanan ? asset('storage/'.$makanan->gambar_makanan) : asset('images/food.png') }}" alt="" />
                        </div>
                        ...
                        <div class="mt-6 sm:mt-8 lg:mt-10">
                          ...
                          <div class="mt-4 sm:items-center sm:gap-4 sm:flex">
                            ...
                            <form action="{{ route('transaksi.store') }}" method="POST" class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                                ...
                                type="submit"
                                title=""
                                class="text-white mt-4 sm:mt-0 bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5   focus:outline-none  flex items-center justify-center"
                                >
                ...
                <section class="py-10 bg-white antialiased  overflow-y-auto">
                    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                      <div class="flex items-center gap-2">
                        ...
                        @else
                        <h2 class="text-2xl font-semibold text-gray-900 ">No Reviews</h2>
                        ...
                        <div class="mt-2 flex items-center gap-2 sm:mt-0">
                            ...
                            <div class="flex items-center gap-0.5">
                                ...
                                @endfor
                                <p class="text-sm font-medium leading-none text-gray-500 ">({{ $makanan->average_rating }})</p>
                                <a href="#" class="text-sm font-medium leading-none text-gray-900 underline hover:no-underline "> {{ $makanan->rating_count }} Reviews </a>
                      ...
                      <div class="my-6 gap-8 sm:flex sm:items-start md:my-8">
                        <div class="shrink-0 space-y-4">
                          <p class="text-2xl font-semibold leading-none text-gray-900 ">{{ $makanan->average_rating }} out of 5</p>
                          {{-- <button type="button" data-modal-target="review-modal" data-modal-toggle="review-modal" class="mb-2 me-2 rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300   ">Write a review</button> --}}
                        </div>
                        ...
                        <div class="mt-6 min-w-0 flex-1 space-y-3 sm:mt-0">
                          <div class="flex items-center gap-2">
                            ...
                            <a href="#" class="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left">{{ $makanan->rating_5 > 0 ? $makanan->rating_5 : 0 }} <span class="hidden sm:inline">reviews</span>
                            </a>
                          </div>
                          ...
                          <div class="flex items-center gap-2">
                            ...
                            <a href="#" class="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left">{{ $makanan->rating_5 > 0 ? $makanan->rating_4 : 0 }} <span class="hidden sm:inline">reviews</span>
                            </a>
                          </div>
                          ...
                          <div class="flex items-center gap-2">
                            ...
                            <a href="#" class="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left">{{ $makanan->rating_3 > 0 ? $makanan->rating_3 : 0 }} <span class="hidden sm:inline">reviews</span></a>
                          </div>
                          ...
                          <div class="flex items-center gap-2">
                            ...
                            <a href="#" class="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left">{{ $makanan->rating_2 > 0 ? $makanan->rating_2 : 0 }} <span class="hidden sm:inline">reviews</span></a>
                          </div>
                          ...
                          <div class="flex items-center gap-2">
                            ...
                            <a href="#" class="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline  sm:w-auto sm:text-left">{{ $makanan->rating_1 > 0 ? $makanan->rating_1 : 0 }} <span class="hidden sm:inline">reviews</span></a>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="gap-3 py-6 sm:flex sm:items-start">
                          <div class="shrink-0 space-y-2 sm:w-48 md:w-72">
                            ...
                            <div class="space-y-0.5">
                              <p class="text-base font-semibold text-gray-900 ">{{ $ulasan->user->name }}</p>
                              <p class="text-sm font-normal text-gray-500 ">{{ $ulasan->updated_at->format('F j, Y \a\t h:i A') }}</p>
                            </div>
                          </div>

                          <div class="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                            <p class="text-base font-normal text-gray-500 ">{{ $ulasan->komen }}</p>
                          </div>
                        </div>
                        @endforeach
                      </div>
