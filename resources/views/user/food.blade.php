...
<div class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
    ...
    <div class="container mx-auto my-8 px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div  role="button" data-modal-target="{{ $makanan->id }}" data-modal-toggle="{{ $makanan->id }}" class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 hover:scale-105 transition-transform duration-200">
                <div class="h-56 w-full">
                  <a href="#">
                    {{-- <img class="mx-auto h-full dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-light.svg" alt="" /> --}}
                    <img class="mx-auto hidden h-full dark:block" src="{{ $makanan->gambar_makanan ? asset('storage/'.$makanan->gambar_makanan) : asset('images/food.png') }}" alt="" />
                  </a>
                </div>
                ...
                <div class="text-lg font-semibold leading-tight text-gray-900  dark:text-white">
                  ...
                  <div class="mt-2 flex items-center gap-2">
                    ...
                    <div class="flex items-center">
                        @for ($i = 1; $i <= 5; $i++)
                        <svg class="h-4 w-4" fill="{{ $i <= $makanan->average_rating ? 'yellow' : 'gray' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <ul class="mt-2 flex items-center gap-4">
                    ...
                    <li class="flex items-center gap-2">
                      ...
                      <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ $makanan->kategoris->nama }}</p>
                    </li>
                  </ul>

                  <div class="mt-4 flex items-center justify-between gap-4">
                    <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">Rp{{ number_format($makanan->harga, 0, ',', '.') }}</p>
